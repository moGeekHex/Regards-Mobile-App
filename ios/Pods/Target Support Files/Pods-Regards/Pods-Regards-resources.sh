...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/TapFontsKitV2/TapFontsKitV2/TapFontsKitV2/Resources/Tajawal-Bold.ttf"
  install_resource "${PODS_ROOT}/TapFontsKitV2/TapFontsKitV2/TapFontsKitV2/Resources/Tajawal-Medium.ttf"
  install_resource "${PODS_ROOT}/TapFontsKitV2/TapFontsKitV2/TapFontsKitV2/Resources/Tajawal-Regular.ttf"
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/TapVisualEffectViewV2/TapVisualEffectViewV2.framework/TapVisualEffectView.nib"
