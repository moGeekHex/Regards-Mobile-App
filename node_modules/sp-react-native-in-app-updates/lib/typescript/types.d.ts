...
export type InstallationResult = AndroidInstallStatus.INSTALLED | AndroidInstallStatus.CANCELED;
...
export type AndroidIntentResultListener = (intentResult: InstallationResult) => void;
...
export type NeedsUpdateResponse = IosNeedsUpdateResponse | AndroidNeedsUpdateResponse;
...
export type StartUpdateOptions = IosStartUpdateOptions | AndroidStartUpdateOptions;
export {};
