...
export class Utility {
     ...
     */
    static runProcess(command, args) {
     ...
     */
    static print(descriptiveTitle, extraInfo = "") {
        console.info("");
     ...
     */
    static printErrorThenExit(...error) {
        console.info("");
     ...
     */
    static prettier(source, checkOnly = false) {
