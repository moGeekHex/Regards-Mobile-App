package com.tamarasdk

import android.app.Activity
import android.widget.Toast
import androidx.fragment.app.Fragment
import com.tamarasdk.error.*
import com.tamarasdk.model.*
...
import com.tamarasdk.model.request.ShippingInfo
...
class TamaraPayment {
    ...
    private fun buildOrder(): Order {
        ...
        order.countryCode = defaultCountryCode
        return order
    }
    ...
    companion object {
        ...
        fun addCustomFieldsAdditionalData(jsonData: String) {
            validateStateForAddingData()
            getInstance().order.updateAdditionalDataFromJson(jsonData)
            println(">>>>>>>>>>>>>Siuuuuu: " + Gson().toJson(getInstance().order))
        }
