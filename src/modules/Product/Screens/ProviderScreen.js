...
import { StyleSheet, View, ScrollView, TouchableOpacity, Platform, KeyboardAvoidingView, FlatList, ActivityIndicator} from 'react-native'
import { Card, PopularProduct, Title, InputSearch, ProductButton, Button, Input, InputPhone, Button as ButtonRn } from '../../../components';
                                   ...
                                   <View style={styles.containerModelPin}>
                                        {
...

                                            {
                                                ...
                                                :
                                                    <>
                                                        <Title text={ lang === "arabic" ? ` أعد ارسال رمز التأكيد` : null } size="1.7" color="#777" fontWeight="600"/>
                                                        <Title text={ lang === "arabic" ? ` ${secondsLeft} ثانية ` : null } size="1.7" color="#000" fontWeight="600"/>
                                                    </>
                                            }
                                             </Card>
