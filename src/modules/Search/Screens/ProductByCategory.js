...
const ProductByCategory = ({ route, navigation }) => {
    ...
    const [phoneOtp, setPhoneOtp] = useState("");
     ...
     const { productsByCategory, loadingProductByCategory, isListEnd, moreLoading } = useSelector(state=>state.productByCategory)
                    ...
                    :
                         ...
                         <View style={styles.containerPopularProducts(lang)}>

                              {
                                   productsByCategory && categoryID ?
                                        <FlatList
                                             ...
                                             ListEmptyComponent={ loadingProductByCategory ? renderEmpty : null}
                              ...
                              }
                              {
                                   ...
                                   ?
                                        productsByCategory.map((productByCategory, key) => {
                                             return (
                                                  <PopularProduct 
                                                       large 
                                   ...
                                   ?
                                        productsByEvent.map((productByEvent, key) => {
                                             return (
                                                  <PopularProduct 
                                                       large 
                                                       data={productByEvent}
