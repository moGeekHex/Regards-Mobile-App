...
const ProductByEvent = ({ route, navigation }) => {
    ...
    const [phoneOtp, setPhoneOtp] = useState("");
     ...
     const eventNameEn = route.params.eventNameEn
     ...
     const { productsByEvent, loadingData, moreLoading, isListEnd } = useSelector(state=>state.productByEvent)
     ...
     const handleOnPressEvent = () => {
          try{
               appEvents({
                    eventName : "show_product_by_events",
                    payload : {
                         event : eventNameEn
                    }
               })
     ...
     const onEndReached = () => {
          console.log("aleart onEndReached ")
          if(!isListEnd){
               setPage(page + 1)
          }
      }
                                   ...
                                   productsByEvent && eventID ?
                                        <FlatList
                                             ...
                                             <PopularProduct
                                                  data={item}
                                                  large
                                                  onPress={() => {handleOnPressEvent(),navigation.navigate('Product', {
                                                       screen : "Product",
                                                       params : {
                                                            id : item.id
                                                       }
